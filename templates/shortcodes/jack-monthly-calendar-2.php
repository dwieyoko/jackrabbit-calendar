...
{
	return '<div style="padding: 20px; background: #fadcb6; text-align: center;">Shortcode jack-monthly-calendar-2 will be displayed here.</div>';
}
...
wp_register_script('jack-monthly-calendar-2', $assets_dir.'jack-monthly-calendar-2/js/main.js', [], JACKCA_VERSION, true);
wp_localize_script('jack-monthly-calendar-2', 'JACKCA_CALENDAR', [
...
wp_enqueue_style( 'jack-monthly-calendar-2', $assets_dir.'jack-monthly-calendar-2/css/index.css', array(), JACKCA_VERSION );
wp_enqueue_script('jack-monthly-calendar-2');

?>

<div id="app-monthly-calendar-2"></div>
<div id="modal"></div>

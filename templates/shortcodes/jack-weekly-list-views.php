...
{
	return '<div style="padding: 20px; background: #fadcb6; text-align: center;">Shortcode jack-weekly-list-views will be displayed here.</div>';
}
...
wp_register_script('jack-weekly-list-views', $assets_dir.'jack-weekly-list-views/js/main.js', [], JACKCA_VERSION, true);
wp_localize_script('jack-weekly-list-views', 'JACKCA_CALENDAR', [
	...
	'btn_week' => $atts['btn_week'],
    'hide_class_type_first_load' => $hide_class_type_first_load,
    'hide_categories' => $hide_categories
] );
wp_enqueue_style( 'jack-weekly-list-views', $assets_dir.'jack-weekly-list-views/css/index.css', array(), JACKCA_VERSION );
wp_enqueue_script('jack-weekly-list-views');

?>

<div id="app-weekly-list-views"></div>
<div id="modal"></div>
